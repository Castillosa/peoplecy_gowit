"""
Django settings for Peoplecy-gowit project.
...
SECRET_KEY = env("SECRET_KEY", default="vvLczmvILUPyzrbyWonPAFLpHcWoFTeTHIOABTqE")
...
ROOT_URLCONF = "peoplecy_gowit.urls"
...
WSGI_APPLICATION = "peoplecy_gowit.wsgi.application"
...
if "DATABASE_URL" in env:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": env("DJANGO_DATABASE_NAME", default="peoplecy_gowit"),
...
LANGUAGE_CODE = "en-us"
LANGUAGE_COOKIE_NAME = "peoplecy_gowit_language"
LANGUAGES = [
...
if USE_S3_MEDIA:
    ...
    AWS_STORAGE_BUCKET_NAME = env("AWS_STORAGE_BUCKET_NAME", default="peoplecy_gowit-media")
...
EMAIL_SUBJECT_PREFIX = "[peoplecy_gowit] "
...
SPECTACULAR_SETTINGS = {
    "TITLE": "peoplecy_gowit",
    "DESCRIPTION": "peoplecy_gowit",
    "VERSION": "0.1.0",
...
PROJECT_METADATA = {
    "NAME": gettext_lazy("peoplecy_gowit"),
    "URL": "http://localhost:8000",
    "DESCRIPTION": gettext_lazy("peoplecy_gowit"),
    "IMAGE": "https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg",
    "KEYWORDS": "SaaS, django",
    "CONTACT_EMAIL": "pacocastillosa@gmail.com",
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [("Paco", "pacocastillosa@gmail.com")]
...
LOGGING = {
    ...
    "loggers": {
        ...
        "peoplecy_gowit": {
            "handlers": ["console"],
            "level": env("peoplecy_gowit_LOG_LEVEL", default="INFO"),
        },
    },
}
